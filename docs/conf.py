...
# sphinx-quickstart on Thu Aug 11 21:22:43 2016.
#
...
exclude_patterns = ['_build', '.pyc', 'test_']
...
man_pages = [
    (
        ...
        'Fetch Public Blacklists Documentation',
        [u'Kendrick Walls'],
        1
    )
]
...
texinfo_documents = [(
    ...
    u'reactive-firewall', 'Fetch Public Blacklists', 'Downloads Public Blacklists.',
    'Miscellaneous'
)]
