...
class BasicTestSuite(unittest.TestCase):
	...
	def test_Int_to_IPv4(self):
		...
		self.assertEqual(helpers.int_to_IPv4(111239847), '6.161.98.167')
		self.assertEqual(helpers.int_to_IPv4(167239847), '9.247.224.167')
		self.assertEqual(helpers.int_to_IPv4(9167239847), '136.154.62.169')
		self.assertEqual(helpers.int_to_IPv4(67306243), '4.3.3.3')
		self.assertEqual(helpers.int_to_IPv4(0), '0.0.0.0')
